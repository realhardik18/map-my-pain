      ...
      <div className="flex">
        ...
        >
          ...
          <div className="px-2 mt-4 mb-2 flex items-center gap-3 py-2">
            <div className={cn("size-8 rounded-full bg-gradient-to-br from-violet-500 to-violet-700", collapsed && "mx-auto")} aria-hidden />
            <div className={cn("min-w-0 flex-1", collapsed && "sr-only")}>
              <p className="text-sm font-medium">Alex Patient</p>
              <p className="truncate text-xs text-zinc-400">alex.patient@example.com</p>
            </div>
            <button
              className={cn(
